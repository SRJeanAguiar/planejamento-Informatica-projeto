...
#ENTREGA 1 CIENCIAS DE DADOS - Análise Descritiva dos Dados
...
#4. **Implementação de modelos preditivos utilizando Python:**
 #   - Desenvolva modelos preditivos com base nas análises estatísticas.
...
# Supondo que você já tenha treinado o modelo com os dados originais e agora quer fazer previsões para novos itens do pedido
# Definir as características dos novos itens do pedido
...
#5. **Avaliação da performance dos modelos preditivos:**
 #   - Utilize métricas de desempenho para avaliar os modelos.
